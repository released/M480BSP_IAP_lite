...
void UART0_Init(void)
{
	...
	printf("\r\nBOOT)CLK_GetCPUFreq : %8d\r\n",CLK_GetCPUFreq());
	printf("BOOT)CLK_GetHCLKFreq : %8d\r\n",CLK_GetHCLKFreq());
	printf("BOOT)CLK_GetHXTFreq : %8d\r\n",CLK_GetHXTFreq());
	printf("BOOT)CLK_GetLXTFreq : %8d\r\n",CLK_GetLXTFreq());	
	printf("BOOT)CLK_GetPCLK0Freq : %8d\r\n",CLK_GetPCLK0Freq());
	printf("BOOT)CLK_GetPCLK1Freq : %8d\r\n",CLK_GetPCLK1Freq());
	printf("BOOT)CLK_GetHCLKFreq : %8d\r\n",CLK_GetHCLKFreq());    	
